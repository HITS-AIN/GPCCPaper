...
function createplots()
    ...
    axtop   = Axis(GL[1, 1], title  = "marginal posterior for 9100", xlabel = "τ (Days)", ylabel = "π")
    xlims!(axtop, 0, 10)
    ...
    axright = Axis(GL[2, 2], title  = "marginal posterior for 7700", ylabel = "τ (Days)", xlabel = "π")
    ylims!(axright, 0, 10)
